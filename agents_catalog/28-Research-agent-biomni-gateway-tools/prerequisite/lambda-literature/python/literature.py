...
def query_pubmed(query: str, max_papers: int = 10, max_retries: int = 3) -> str:
    ...
    try:
        pubmed_email = get_ssm_parameter("/app/researchapp/pubmed_email") or "your-email@example.com"
...
#         if not api_key:
#             api_key = get_ssm_parameter("/app/researchapp/anthropic_api_key") or os.getenv("ANTHROPIC_API_KEY")
#     except ImportError:
